...
multi_norm = function(m, n) return(replicate(m, prod(1 + runif(12, 0, n))))

log_norm = function(m, n) return(replicate(m, log(prod(1 + runif(12, 0, n)))))

if (sys.nframe() == 0) {
    m = 10000
    for (n in c(4, 8, 16)) add_norm(m, n)
